...
export default function Downloads() {
    return <article className="prose max-w-none prose-slate prose-invert md:px-12">
        ...
        <p>Well, it's been a while since I've started this project, and the team is no longer active. However, I'll try my best to keep Woof OS, as a project, running and alive. So, where are the downloads? They're not here yet as I'm still working on Woof OS and a place to host the ISOs. The old ISOs (be warned that many of the ISOs are broken) can be found in <Link href="https://github.com/woof-os/isos-qtile" target="_blank">the isos-qtile repository</Link>.
        </p>
        <p>
