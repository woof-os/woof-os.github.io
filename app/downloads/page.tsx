...
export default function Downloads() {
	...
	<h2>Sway Edition</h2>
        <span className="flex flex-col gap-2 md:flex-row md:gap-12">
            <span>
                <h4>LeWoof Mirror</h4>
                <Link href="https://dl.os.lewoof.xyz/sway/woofos-sway-x86_64.iso" target="_blank">Latest release</Link>
                <br />
                <Link href="https://dl.os.lewoof.xyz/sway">Browse downloads</Link>
            </span>
            <span>
                <h4>Github Mirror</h4>
                <Link href="https://github.com/woof-os/isos-sway/releases/latest/download/woofos-sway.iso" target="_blank">Latest release</Link>
                <br />
                <Link href="https://github.com/woof-os/isos-sway/releases">Browse downloads</Link>
            </span>
        </span>
