...
export default function Home() {
    return <article>
        <div>
            ...
            <p>
                The configuration files and any packages outside the Arch Linux repositories used in Woof OS are also available to install through our pacman repository. You can find the repository information on the <Link target="_blank" href="/pacman">pacman</Link> page.
            </p>
            ...
            <p>
                If you would like to contribute to the project for me to release more editions, you can <Link target="_blank" href="#contact">get in touch with me</Link>, or <Link target="_blank" href="#donate">donate</Link> to the project (information at the bottom of the page).
            </p>
        </div>
