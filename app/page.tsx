...
export default function Home() {
    return <article>
        <div>
            ...
            <h2>Editions</h2>
            <p>
                Woof OS Sway edition is now under development thanks to <Link href="https://github.com/akirapearl">Akirapearl</Link>.
            </p>
            <p>
                If you would like to contribute to the project for me to release more editions, you can <Link href="#contact">get in touch with me</Link>, or <Link href="#donate">donate</Link> to the project (information at the bottom of the page).
            </p>
        </div>
